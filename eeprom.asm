...
;	eeprom.c:44: printf(" \n\r Hello, In EEPROM Demo mode");
	...
	dec	sp
	dec	sp
;	eeprom.c:45: print_eeprom_menu();
	lcall	_print_eeprom_menu
;	eeprom.c:48: wrong_choice_pca:
00101$:
;	eeprom.c:49: printf("Please make a valid choice\n\r");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	eeprom.c:50: inp = getchar();
	lcall	_getchar
	mov	r6,dpl
	mov	r7,dph
;	eeprom.c:51: if (inp == 0x52)
	cjne	r6,#0x52,00115$
	cjne	r7,#0x00,00115$
;	eeprom.c:52: read_random_byte();
	lcall	_read_random_byte
	sjmp	00129$
00115$:
;	eeprom.c:53: else if (inp == 0x57)
	cjne	r6,#0x57,00112$
	cjne	r7,#0x00,00112$
;	eeprom.c:54: write_random_byte();
	lcall	_write_random_byte
	sjmp	00129$
00112$:
;	eeprom.c:55: else if (inp == 0x44)
	cjne	r6,#0x44,00109$
	cjne	r7,#0x00,00109$
;	eeprom.c:56: hexdump_eeprom();
	lcall	_hexdump_eeprom
	sjmp	00129$
00109$:
;	eeprom.c:57: else if (inp == 0x42)
	cjne	r6,#0x42,00106$
	cjne	r7,#0x00,00106$
;	eeprom.c:58: blockfill_eeprom();
	lcall	_blockfill_eeprom
	sjmp	00129$
00106$:
;	eeprom.c:59: else if (inp == 0x46)
	cjne	r6,#0x46,00101$
	cjne	r7,#0x00,00101$
;	eeprom.c:61: i2c_eeprom_reset();
...
;	eeprom.c:68: printf("\n\rPlease 'E' to go to EEPROM Menu \n\r");
	...
	dec	sp
	dec	sp
;	eeprom.c:69: inp = getchar();
	lcall	_getchar
	mov	r6,dpl
	mov	r7,dph
;	eeprom.c:70: if (inp == 0x45)
	cjne	r6,#0x45,00117$
	cjne	r7,#0x00,00117$
;	eeprom.c:71: eeprom_menu();
;	eeprom.c:73: goto exit_choice;
;	eeprom.c:74: }
	ljmp	_eeprom_menu
;------------------------------------------------------------
...
;------------------------------------------------------------
;	eeprom.c:82: void read_random_byte()
;	-----------------------------------------
;	 function read_random_byte
;	-----------------------------------------
_read_random_byte:
;	eeprom.c:87: get_valid_hex:
00101$:
;	eeprom.c:88: printf("\n\r Please give a valid address to read from (0x000 - 0x7FF) \n\r");
	...
	dec	sp
	dec	sp
;	eeprom.c:89: a = get_number_hex(3);
	mov	dptr,#0x0003
	lcall	_get_number_hex
	mov	r6,dpl
;	eeprom.c:91: if (a >= 0 && a <= 2047)
	mov	a,dph
	mov	r7,a
	jb	acc.7,00101$
	clr	c
	...
	subb	a,b
	jc	00101$
;	eeprom.c:93: block = (a & 0xF00) >> 8;
	mov	a,#0x0f
	anl	a,r7
;	eeprom.c:94: address = a & 0x0FF;
;	eeprom.c:101: printf("Block is is %x \n\r", block);
	mov	r4,a
	mov	r5,a
	mov	r7,#0x00
	push	ar6
	...
	pop	ar4
	pop	ar6
;	eeprom.c:102: printf("Address is 0x%X \n\r", address);
	mov	ar5,r6
	mov	r7,#0x00
	push	ar6
	push	ar4
...
;------------------------------------------------------------
;	eeprom.c:111: void write_random_byte()
;	-----------------------------------------
;	 function write_random_byte
;	-----------------------------------------
_write_random_byte:
;	eeprom.c:116: get_valid_hex_address:
00101$:
;	eeprom.c:117: printf("Please give a valid address to write to (0x000 - 0x7FF) \n\r");
	mov	a,#___str_8
	push	acc
	mov	a,#(___str_8 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	eeprom.c:118: a = get_number_hex(3);
	mov	dptr,#0x0003
	lcall	_get_number_hex
	mov	r6,dpl
;	eeprom.c:120: if (a >= 0 && a <= 2047)
	mov	a,dph
	mov	r7,a
	jb	acc.7,00101$
	clr	c
	...
	subb	a,b
	jc	00101$
;	eeprom.c:122: block = (a & 0xF00) >> 8;
	mov	r4,#0x00
	mov	a,#0x0f
	anl	a,r7
	mov	r5,a
;	eeprom.c:123: address = a & 0x0FF;
;	eeprom.c:130: get_valid_hex_value:
00106$:
;	eeprom.c:131: printf("\n\rPlease give a valid data to write (0x00 - 0xFF) \n\r");
	...
	dec	sp
	dec	sp
;	eeprom.c:132: a = get_number_hex(2);
	mov	dptr,#0x0002
	lcall	_get_number_hex
	mov	r4,dpl
	mov	r7,dph
...
;	eeprom.c:134: if (a >= 0)
	mov	a,r7
	jb	acc.7,00106$
;	eeprom.c:136: i2c_write_random(block, address, (unsigned char)a);
	mov	ar3,r4
...
;------------------------------------------------------------
;	eeprom.c:151: void hexdump_eeprom()
;	-----------------------------------------
;	 function hexdump_eeprom
;	-----------------------------------------
_hexdump_eeprom:
;	eeprom.c:155: get_valid_from_address:
00101$:
;	eeprom.c:156: printf("Please give a valid starting address (0x000 - 0x7FF) \n\r");
	mov	a,#___str_11
	push	acc
	mov	a,#(___str_11 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	eeprom.c:157: a = get_number_hex(3);
	mov	dptr,#0x0003
	lcall	_get_number_hex
	mov	r6,dpl
;	eeprom.c:159: if (a < 0 || a > 2047)
	mov	a,dph
	mov	r7,a
	jb	acc.7,00101$
	clr	c
	...
	subb	a,b
	jc	00101$
;	eeprom.c:164: get_valid_to_address:
00105$:
;	eeprom.c:165: printf("Please give a valid ending address (0x%X - 0x7FF) \n\r", a);
	push	ar7
	push	ar6
	push	ar6
	push	ar7
	...
	add	a,#0xfb
	mov	sp,a
;	eeprom.c:166: b = get_number_hex(3);
	mov	dptr,#0x0003
	lcall	_get_number_hex
	mov	r4,dpl
	mov	r5,dph
...
;	eeprom.c:168: if (b < a || b > 2047)
	...
	subb	a,b
	jc	00105$
;	eeprom.c:173: eeprom_buffer.buffer_start = malloc((b - a) + 5);
	mov	a,r4
	clr	c
	subb	a,r6
	mov	r2,a
	...
	inc	dptr
	movx	@dptr,a
;	eeprom.c:175: eeprom_buffer.buff_size = (b - a) + 5;
	...
	inc	dptr
	movx	@dptr,a
;	eeprom.c:176: eeprom_buffer.buffer_num = 0;
	mov	dptr,#_eeprom_buffer
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	eeprom.c:177: eeprom_buffer.buffer_end = eeprom_buffer.buffer_start + (b - a) + 5;
	mov	a,r2
	add	a,r0
	mov	r2,a
	mov	a,r3
	...
	inc	dptr
	movx	@dptr,a
;	eeprom.c:178: eeprom_buffer.num_char = 0;
	mov	dptr,#(_eeprom_buffer + 0x000a)
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	eeprom.c:180: printf("Reading EEPROM...\n\r");
	push	ar7
	push	ar6
	push	ar5
	push	ar4
	...
	pop	ar6
	pop	ar7
;	eeprom.c:182: for (int l = a; l <= b; l++)
	mov	_hexdump_eeprom_sloc0_1_0,r6
	mov	(_hexdump_eeprom_sloc0_1_0 + 1),r7
;	eeprom.c:191: free(eeprom_buffer.buffer_start);
	pop	ar5
	pop	ar4
;	eeprom.c:182: for (int l = a; l <= b; l++)
00111$:
	...
	subb	a,b
	jc	00109$
;	eeprom.c:185: data = i2c_read_random((l & 0xF00) >> 8, (l & 0x0FF));
	push	ar4
	push	ar5
	mov	a,#0x0f
	...
	pop	ar6
	pop	ar7
;	eeprom.c:186: *(eeprom_buffer.buffer_start + eeprom_buffer.num_char) = data;
	mov	dptr,#(_eeprom_buffer + 0x0002)
	movx	a,@dptr
	mov	r0,a
	inc	dptr
	...
	mov	a,r3
	lcall	__gptrput
;	eeprom.c:187: eeprom_buffer.num_char += 1;
	mov	dptr,#(_eeprom_buffer + 0x000a)
	movx	a,@dptr
	mov	r4,a
	inc	dptr
...
00153$:
	...
	sjmp	00111$
00109$:
;	eeprom.c:190: dump_eeprom_buffer(a);
	mov	dpl,r6
	mov	dph,r7
...
;------------------------------------------------------------
;	eeprom.c:199: void blockfill_eeprom()
;	-----------------------------------------
;	 function blockfill_eeprom
;	-----------------------------------------
_blockfill_eeprom:
;	eeprom.c:203: get_blockfill_from_address:
00101$:
;	eeprom.c:204: printf("Please give a valid starting address (0x000 - 0x7FF) \n\r");
	mov	a,#___str_11
	push	acc
	mov	a,#(___str_11 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	eeprom.c:205: a = get_number_hex(3);
	mov	dptr,#0x0003
	lcall	_get_number_hex
	mov	r6,dpl
;	eeprom.c:207: if (a < 0 || a > 2047)
	mov	a,dph
	mov	r7,a
	jb	acc.7,00101$
	clr	c
	...
	subb	a,b
	jc	00101$
;	eeprom.c:212: get_blockfill_to_address:
00105$:
;	eeprom.c:213: printf("Please give a valid ending address (0x%X - 0x7FF) \n\r", a);
	push	ar7
	push	ar6
	push	ar6
	push	ar7
	...
	add	a,#0xfb
	mov	sp,a
;	eeprom.c:214: b = get_number_hex(3);
	mov	dptr,#0x0003
	lcall	_get_number_hex
	mov	r4,dpl
	mov	r5,dph
...
;	eeprom.c:222: printf("\n\rPlease give a valid data for blockfill (0x00 - 0xFF) \n\r");
	...
	dec	sp
	dec	sp
;	eeprom.c:223: c = get_number_hex(2);
	mov	dptr,#0x0002
	lcall	_get_number_hex
	mov	r2,dpl
	mov	r3,dph
;	eeprom.c:225: printf("Writing EEPROM...\n\r");
	push	ar3
	push	ar2
	mov	a,#___str_15
	push	acc
	...
	pop	ar6
	pop	ar7
;	eeprom.c:226: for (int l = a; l <= b; l++)
00112$:
	clr	c
	mov	a,r4
	subb	a,r6
	...
	subb	a,b
	jc	00110$
;	eeprom.c:228: i2c_write_random((l & 0xF00) >> 8, (l & 0x0FF), (unsigned char)c);
	mov	a,#0x0f
	anl	a,r7
	mov	r0,a
	mov	dptr,#_i2c_write_random_PARM_2
...
;------------------------------------------------------------
;	eeprom.c:239: void print_eeprom_menu()
;	-----------------------------------------
...
;	eeprom.c:241: printf("\n\n\r^^^^^^^^^^^^^^^^^^^-EEPROM-MENU-^^^^^^^^^^^^^^^^^^^^^^^^^^ \n\n\r");
	...
	dec	sp
	dec	sp
;	eeprom.c:242: printf("'R' -> Read Random Byte\n\r");
	mov	a,#___str_18
	push	acc
	mov	a,#(___str_18 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	eeprom.c:243: printf("'W' -> Write Random Byte\n\r");
	mov	a,#___str_19
	push	acc
	mov	a,#(___str_19 >> 8)
	push	acc
...
;	eeprom.c:244: printf("'D' -> Hexdump\n\r");
	...
	dec	sp
	dec	sp
;	eeprom.c:245: printf("'B' -> Block Fill\n\r");
	mov	a,#___str_21
	push	acc
	mov	a,#(___str_21 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	eeprom.c:246: printf("'F' -> Reset EEPROM \n\r");
	mov	a,#___str_22
	push	acc
	mov	a,#(___str_22 >> 8)
	push	acc
...
;------------------------------------------------------------
;	eeprom.c:254: void dump_eeprom_buffer(int from)
;	-----------------------------------------
...
;	eeprom.c:259: int j = 16;
	...
	inc	dptr
	movx	@dptr,a
;	eeprom.c:261: for (int i = 0; i < eeprom_buffer.num_char; i++)
	mov	dptr,#_dump_eeprom_buffer_from_65536_73
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
;	eeprom.c:265: printf("\n\r0x%03X: ", (from + i));
	...
	pop	ar7
00102$:
;	eeprom.c:267: printf("%02X ", *(eeprom_buffer.buffer_start + i));
	mov	dptr,#(_eeprom_buffer + 0x0002)
	movx	a,@dptr
	mov	r1,a
	inc	dptr
