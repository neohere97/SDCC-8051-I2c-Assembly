default:
	...
	sdcc --model-large program.rel i2c_routines.rel i2c.rel asa.rel getput.rel buffer.rel pca.rel eeprom.rel lcd.rel asm_c.rel _heap.rel 
	...
	del _heap.asm asm_c.asm buffer.asm eeprom.asm getput.asm i2c.asm pca.asm program.asm program.hex program.ihx program.lk lcd.asm
