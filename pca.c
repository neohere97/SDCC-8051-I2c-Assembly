...
// ------------------------------------------------hardware-watchdog-------------------------------------------------
/***********************************************************************************
 * function : initializes the hardware watchdog
 * parameters : none
 * return : none
 ***********************************************************************************/
void hardware_watchdog()
...
// ------------------------------------------------fclk-lowest-------------------------------------------------
/***********************************************************************************
 * function : puts the processer to it's lowest clock
 * parameters : none
 * return : none
 ***********************************************************************************/
void fclk_lowest()
